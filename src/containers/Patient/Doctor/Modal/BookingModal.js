...
import { postPaitentBooking } from "../../../../services/userService";
class BookingModal extends Component {
  ...
  handleConfirmBooking = async () => {
    ...
    if (res && res.errCode === 0) {
      ...
      this.props.closeBookingModalClose();
    } else {
      ...
      >
        <div className="booking-modal-content">
          <div className="booking-modal-header">
            <span className="left">
              {" "}
              <FormattedMessage id="patient.booking-modal.infor" />
            </span>
            <span className="right" onClick={closeBookingModalClose}>
          ...
          <div className="booking-modal-footer">
            ...
            <button
              ...
              onClick={closeBookingModalClose}
            >
